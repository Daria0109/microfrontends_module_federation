...
```
$ curl http://localhost:3001/unauthorized
$ # result -> true
```
...
```
$ curl http://localhost:3001/authorized
...
$ curl http://localhost:3001/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2Vybm..."
$ # result -> {"userId":2}
```
